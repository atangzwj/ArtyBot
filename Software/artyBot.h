...
#define MOTOR1_FORWARD  XGpio_DiscreteWrite(xgpio0, M1_CHANNEL, 0x1) // changed
#define MOTOR1_BACKWARD XGpio_DiscreteWrite(xgpio0, M1_CHANNEL, 0x0) // 0x3 to
#define MOTOR2_FORWARD  XGpio_DiscreteWrite(xgpio0, M2_CHANNEL, 0x0) // 0x1
#define MOTOR2_BACKWARD XGpio_DiscreteWrite(xgpio0, M1_CHANNEL, 0x1)
